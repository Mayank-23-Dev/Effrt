...
const orbits = [
  {
    size: "w-[300px] h-[300px] md:w-[420px] md:h-[420px]",
    duration: 18,
    icons: [
  ...
  {
    size: "w-[420px] h-[420px] md:w-[580px] md:h-[580px]",
    duration: 24,
    icons: [
  ...
  {
    size: "w-[540px] h-[540px] md:w-[740px] md:h-[740px]",
    duration: 30,
    icons: [
...
export default function OrbitingCirclesGlobeDemo() {
  return (
    <div className="relative w-full h-[320px] md:h-[460px] overflow-hidden flex justify-center">
      <style>{`
        @keyframes orbit-cw {
      ...
      {/* Center particle globe (Positioned at bottom edge, larger size) */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 aspect-square pointer-events-none w-[240px] h-[240px] md:w-[380px] md:h-[380px] z-10">
        <ParticleSphereAnimation />
      </div>

      {/* Orbiting rings (Positioned at bottom edge) */}
        ...
        return (
          ...
          >
            {allIcons.map((iconData, iconIndex) => (
              ...
              >
                <div
                  className="p-2 sm:p-3 border border-border rounded-full bg-background -mt-6 relative z-10"
                  style={
                    {
